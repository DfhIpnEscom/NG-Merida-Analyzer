...
# Debug mode, en caso de habilitar para pruebas
def run_debug_once():
...
# manejador de señales para cierres
...
if __name__ == "__main__":
    try:
        ...
        # en caso de estar activado el debug se prueba sin detener
        run_debug_once()

        # Loop principal que mantiene actividad
        while True:
            time.sleep(1)
    except Exception as e:
